...
export class CustomersController {
  ...
  async create(@Body() createCustomerDto: CreateCustomerDto, @CurrentCustomer() currentCustomer: any) {
    ...
    return this.customersService.create({
      ...
      ownerUuid: currentCustomer.customer.ownerUuid || currentCustomer.customer.uuid
    });
  }
  ...
  register(@Body() createCustomerDto: CreateCustomerDto) {
    ...
    return this.customersService.create({
      ...
      ownerUuid: null // Will be set after role assignment
    });
  }
  ...
  async findAll(
    ...
    return this.customersService.findAllPaginated(paginationDto, currentCustomer.customer);
  }
  ...
  async findOne(@Param('uuid') uuid: string, @CurrentCustomer() currentCustomer: any) {
    ...
    return this.customersService.findOne(uuid, true);
  }
